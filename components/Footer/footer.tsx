...
// import {AiFillLinkedin} from 'react-icons/aifill'
...
<p className = "text-gray-500">Design by. <br/><span className = "font-bold text-black">Ahmed Sheikh</span></p>
<p className = "text-gray-500">Code by.<span className ="font-bold text-black"> ahmedsheikh95<br/> on github</span></p>
